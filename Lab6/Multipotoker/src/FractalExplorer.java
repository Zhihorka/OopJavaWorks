...
public class FractalExplorer {
    ...
    public void setGUI() {
        ...
        buttonReset = new JButton("Переделать");
        buttonReset.setActionCommand("Переделать");
    ...
    // отрисовка картинки с фракталом
    private void drawFractal() {
        // интерфейс не работает пока рисуется фрактал
        enableGUI(false);
    ...
    // это для включения и отключения интерфейса
    ...
    public class ActionHandler implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            if (e.getActionCommand().equals("Переделать")) {
        ...
        protected Object doInBackground() throws Exception {
            ...
            for (int i = 0; i < displaySize; i++) {
                ...
                if (count == -1)
                    ...
                    double hue = 0.1f + (float) count / 100f;
